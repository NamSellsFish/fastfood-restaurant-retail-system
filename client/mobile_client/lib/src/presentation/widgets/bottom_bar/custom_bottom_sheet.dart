      ...
      child: Column(
        ...
        children: [
          ...
          const Row(
            children: [
              PayContainers(
                  imagepath: 'assets/images/bottom_offers/_amazon_pay.png',
                  belowText: 'Pay Bills, Send Money & more',
                  onPressedString: 'MoMo Wallet'),
              SizedBox(width: 10),
              PayContainers(
                  imagepath: 'assets/images/minitv.png',
                  belowText: 'Watch Free Events & Live stream',
                  onPressedString: 'FastFood+ MiniTV'),
            ],
          )
        ],
      ),
