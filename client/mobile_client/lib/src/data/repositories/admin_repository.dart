...
class AdminRepository {
  ...
  Future<List<String>> uploadImages({
    ...
    try {
      ...
      String folder;
      const String cloudinaryCloudName = "dkirx8mro";
      const String cloudinaryUploadPreset = "vzgmob1e";
  ...
  Future<Map<String, dynamic>> adminGetAnalytics() async {
    try {
      ...
      if (res.statusCode == 200) {
        ...
        sales = [
          Sales('Chicken', resDecoded['chickenEarnings'] ?? 0),
          Sales('Hamburger', resDecoded['hamburgerEarnings'] ?? 0),
          Sales('Meal with Rice', resDecoded['mealWithRiceEarnings'] ?? 0),
          Sales('Spaghetti', resDecoded['spaghettiEarnings'] ?? 0),
          Sales('Pizza', resDecoded['pizzaEarnings'] ?? 0),
          Sales('Snack', resDecoded['snackEarnings'] ?? 0),
          Sales('Drink', resDecoded['drinkEarnings'] ?? 0),
          Sales('Dessert', resDecoded['dessertEarnings'] ?? 0),
          Sales('Cuisine', resDecoded['cuisineEarnings'] ?? 0),
        ];
