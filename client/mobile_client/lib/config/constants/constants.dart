const String articleAPIBaseURL = 'https://newsapi.org/v2';
const String API_KEY = 'ff957763c54c44d8b00e5e082bc76cb0';
const String COUNTRY_QUERY = 'us';
const String CATEGORY_QUERY = 'general';
