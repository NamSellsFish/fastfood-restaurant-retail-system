  ...
  group('Real account api test', () {
    test('Invalid tokens return 401', () async {
      ...
      final responses = {
        ...
        i.addToWishList.toString():
          () => i.addToWishList(product: testProduct),
        i.deleteFromWishList.toString():
          () => i.deleteFromWishList(product: testProduct),
        i.fetchMyOrders.toString():
          () => i.fetchMyOrders(),
        i.getAverageRating.toString():
          () => i.getAverageRating(testProduct.id!),
        i.getKeepShoppingFor.toString():
          () => i.getKeepShoppingFor(),
        i.getProductRating.toString():
          () => i.getProductRating(testProduct),
        i.getWishList.toString():
          () => i.getWishList(),
        i.isWishListed.toString():
          () => i.isWishListed(product: testProduct),
        i.rateProduct.toString():
          () => i.rateProduct(product: testProduct, rating: 0),
        i.searchOrders.toString():
          () => i.searchOrders('invalidQueryText')
      };
